...
export default props => {
    ...
    return (
        <div className='modalMoreInfo' id='modalMoreInfo'>
            ...
            <main>
                <table className='table' key={props.id_doctor} role='form'>
                    <tbody>
                        <tr>
                            <td>
                                <p>Id:</p>
                            ...
                            <td>
                                <input type='text' value={props.id_doctor} disabled id='idMoreInfo' />
                            </td>
                        </tr>
                        <tr>
                            <td>
                        ...
                        <tr>
                            ...
                            <td>
                                <input type='text' value={props.expertise} id='expertiseMoreInfo' />
                            </td>
                        </tr>
                        <tr>
                            <td>
            ...
            <footer>
                <IconButton style='info' icon='floppy-o' title='Save' onClick={props.handleCreateDoctor} />
            </footer>
        </div>
    )
}